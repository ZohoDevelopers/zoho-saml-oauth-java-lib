...
public class OAuth extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res)throws ServletException, IOException  
	{
		try
		{
			...
			if(state==null)
			{
				...
				url.setParameter(OAuthConstants.SCOPE, OAuthUtil.getCRMScope())
	...
	public void init(ServletConfig config) throws ServletException {
		...
		FileInputStream samlConfigFile;
		try 
		{
			samlConfigFile = new FileInputStream(OAuthConfFolder+"/property.properties");
			OAuthUtil.setProp(new Properties());
			OAuthUtil.getProp().load(samlConfigFile);
